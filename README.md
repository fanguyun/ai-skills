...
| `project-security-scan` | `$project-security-scan` | 对 Node.js/TypeScript 仓库执行只读的项目安全审计，覆盖生产依赖、业务代码与交付配置风险，并输出含证据与修复建议的报告。 | `SKILL.md`、`README.md`、`agents/openai.yaml`、`references/` |
